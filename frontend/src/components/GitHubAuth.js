...
function GitHubAuth({ onSuccess }) {
  const handleGitHubLogin = () => {
    ...
    if (!clientId || clientId === 'your-github-client-id') {
      alert('GitHub OAuth is not configured. Please set REACT_APP_GITHUB_CLIENT_ID in your environment variables.');
      console.error('Missing REACT_APP_GITHUB_CLIENT_ID environment variable');
      return;
    }
    ...
    // Store state for verification (in production, use more secure method)
